...
Green flash = normal navigation, red flash = blocked/busy.
"""
...
class ClickFlash(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._opacity = 0.0
        self._color = QColor(100, 200, 100)  # green
    ...
    def flash(self, rect: QRect, blocked: bool = False):
        self._color = QColor(220, 60, 60) if blocked else QColor(100, 200, 100)
