...
- `core-ipc-contracts` -> shared channel/event contract (`runtime/electron_legacy/shared/ipc.js`)
- `core-storage` -> storage ownership map (`runtime/electron_legacy/main/lib/storage.js`)
