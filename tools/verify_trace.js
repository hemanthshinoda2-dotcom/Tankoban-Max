...
function verifyTrace({ appRoot }) {
  const mustHave = [
    { rel: 'runtime/electron_legacy/preload/index.js', token: 'TRACE:IPC_OUT' },
    { rel: 'runtime/electron_legacy/main/ipc/index.js', token: 'TRACE:IPC_IN' },
    { rel: 'runtime/electron_legacy/main/lib/storage.js', token: 'TRACE:PERSIST_WRITE' },
    { rel: 'src/services/api_gateway.js', token: 'TRACE:IPC_OUT' },
    { rel: 'runtime/electron_legacy/workers/library_scan_worker_impl.js', token: 'TRACE:PERSIST_WRITE' },
    { rel: 'runtime/electron_legacy/workers/video_scan_worker_impl.js', token: 'TRACE:PERSIST_WRITE' },
  ];
