  ...
  onReady(function init(){
    ...
    function createParentBridge() {
      ...
      return {
        ...
        torrentStartConfigured: function(payload){ return Promise.resolve(e(['webTorrent','startConfigured'], [payload || {}], { ok:false })).catch(function(){ return { ok:false }; }); },
        torrentPause: function(id){ return Promise.resolve(e(['webTorrent','pause'], [id], { ok:false })).catch(function(){ return { ok:false }; }); },
        torrentResume: function(id){ return Promise.resolve(e(['webTorrent','resume'], [id], { ok:false })).catch(function(){ return { ok:false }; }); },
        torrentCancel: function(id){ return Promise.resolve(e(['webTorrent','cancel'], [id], { ok:false })).catch(function(){ return { ok:false }; }); },
        torrentRetry: function(id){ return Promise.resolve(e(['webTorrent','retry'], [id], { ok:false })).catch(function(){ return { ok:false }; }); },
        torrentRemove: function(id, opts){ return Promise.resolve(e(['webTorrent','remove'], [id, opts || {}], { ok:false })).catch(function(){ return { ok:false }; }); },
        ...
        torrentGetPeers: function(id){ return Promise.resolve(e(['webTorrent','getPeers'], [id], { ok:false, peers:[] })).catch(function(){ return { ok:false, peers:[] }; }); },
        ...
        torrentStartMagnet: function(uri){ return Promise.resolve(e(['webTorrent','startMagnet'], [uri], false)).catch(function(){ return false; }); },
        torrentStartUrl: function(url){ return Promise.resolve(e(['webTorrent','startTorrentUrl'], [url], false)).catch(function(){ return false; }); },
        ...
        torrentSelectFiles: function(id, indices){ return Promise.resolve(e(['webTorrent','selectFiles'], [{ id: id, indices: indices }], false)).catch(function(){ return false; }); },
