...
Quick run (Windows, Max repo): run `projects/Tankoban Max/install_and_run.bat`.
Portable validation run: run `projects/Tankoban Max/run_portable.bat`.
Full installer path (slow): run `projects/Tankoban Max/dist_install_and_run.bat`.
